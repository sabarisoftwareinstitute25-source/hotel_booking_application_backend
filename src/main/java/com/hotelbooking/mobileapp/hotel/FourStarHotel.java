...
public class FourStarHotel {
    ...
    private Map<String, Boolean> wellness;
    ...
    public Boolean getStarCertification() {
        return starCertification;
    }

    public void setStarCertification(Boolean starCertification) {
        this.starCertification = starCertification;
    }
    ...
    public Map<String, Boolean> getWellness() {
        return wellness;
    }

    public void setWellness(Map<String, Boolean> wellness) {
